...
public class Employee_Data {
    public static List<Employee_Reference> getEmployee() {
        ...
        list.add(new Employee_Reference(1002, "TaoBao", 12, 9876.12));
        list.add(new Employee_Reference(1003, "JingDong", 33, 3000.82));
        ...
        list.add(new Employee_Reference(1008, "FaceBook", 35, 2500.32));
